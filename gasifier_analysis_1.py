...
class GasifierDataAnalysis:
    ...
    def __init__(self, run_id, run_information = None):
        ...
        #self.interface_raw = db.db_interface(host = "192.168.13.15", user = "script-user", passwd = "8y__RzQ9")
        ...
        #self.interface_proc = db.db_interface(host = "192.168.10.20", user = "script-user", passwd = "8y__RzQ9")
    ...
    def _setup_standard_streams(self):
        ...
        m_type = "CO2"
        ###this is a problem!!!!###
        cross_brush_feed = Stream('cross_brush_feed', flowrate = self.gts.val_units('mass_flow_entrainment'), composition = {e_type:1.0}, basis = "gas_volume")
        down_bed_feed = Stream('down_bed_feed', flowrate = self.gts.val_units('mass_flow_down_brush'), composition = {e_type:1.0}, basis = "gas_volume")
        
        
        if self.run_info.info['makeup_flow'] < 0.01:
            makeup_feed = Stream('makeup_feed', flowrate = (0,'L/min'), composition = {m_type:1.0}, basis = "gas_volume")
        else:
            makeup_feed = Stream('makeup_feed', flowrate = self.gts.val_units('mass_flow_feed_vessel_pressure'), composition = {m_type:1.0}, basis = "gas_volume")
        argon_tracer_feed = Stream('argon_tracer', flowrate = self.gts.val_units('mass_flow_argon_tracer'), composition = {'Ar':1.0}, basis = "gas_volume")
        methane_gas_feed = Stream('methane_feed', flowrate = self.gts.val_units('mass_flow_methane'),composition = {'CH4':1.00}, basis = "gas_volume")
        ...
        cross_brush_feed.pressure = (101325.0, 'Pa')
        down_bed_feed.pressure = (101325.0, 'Pa')
        makeup_feed.pressure = (101325.0, 'Pa')

        
        argon_tracer_feed.pressure = (101325.0, 'Pa')
        methane_gas_feed.pressure = (101325.0, 'Pa')
        ...
        self.gts.proc_species = ['H2', 'CO', 'CO2', 'CH4', 'C2H6', 'N2', 'C2H4', 'C2H2', 'C6H6', 'Ar', 'C7H8', 'C10H8', 'C3H8', 'C3H6']
